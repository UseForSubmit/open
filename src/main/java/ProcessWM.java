...
public class ProcessWM {
    public static void main(String[] args) throws IOException {
        ...
        final int max_can = 7;       //the max candidates a vertex can have including itself
        final int max_loss = 100;    //threshold to abandon a candidate
        final double cover = 0.8;    //percent of servable vertices with core vertices
        ...
        in = new InputStreamReader(new FileInputStream(data_source + "_graph_j.json"));
        ...
        jsonObject = gson.toJson(Vco_);
        out = new OutputStreamWriter(new FileOutputStream(file_parameter + "raw_solu.json"));
        out.write(jsonObject, 0, jsonObject.length());
        out.close();
        jsonObject = gson.toJson(PSC_solver.V_cost);
        out = new OutputStreamWriter(new FileOutputStream(file_parameter + "vcost.json"));
        out.write(jsonObject, 0, jsonObject.length());
        out.close();
